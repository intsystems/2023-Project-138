...
class UniformAffineQuantizer(nn.Module):
    ...
    def __init__(self, n_bits: int = 8, symmetric: bool = False, channel_wise: bool = False,
                 ...
                 leaf_param: bool = False, prob: float = 1.0, is_cnn=False, quantize_clipped=True, additional_levels_num=0):
    ...
    def perform_2D_search(self, x):
        ...
        for i in range(1, self.num + 1):
            ...
            tmp_delta = (tmp_max - tmp_min) / (self.n_levels - 1)
            # enumerate zp
...
class QuantModule(nn.Module):
    ...
    def __init__(self, org_module: Union[nn.Conv2d, nn.Linear], weight_quant_params: dict = {},
        ...
        self.weight_quantizer = UniformAffineQuantizer(**weight_quant_params, is_cnn=self.is_cnn)
