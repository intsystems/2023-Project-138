...
if __name__ == '__main__':
    ...
    wq_params = {'n_bits': args.n_bits_w, 'channel_wise': args.channel_wise, 'scale_method': args.init_wmode, 'quantize_clipped':args.quantize_clipped, 'additional_levels_num':args.additional_levels_num}
    ...
    def recon_model(model: nn.Module):
        ...
        for name, module in model.named_children():
            if isinstance(module, QuantModule):
                ...
                recon_model(module)
    # Start calibration
    if not args.use_basic_quantization:
        recon_model(qnn)
